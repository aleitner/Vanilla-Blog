...
class BlogpostsControllerTest < ActionController::TestCase
  ...
  test "should create blogpost" do
    assert_difference('Blogpost.count') do
      post :create, blogpost: { comment_id: @blogpost.comment_id, content: @blogpost.content, user_id: @blogpost.user_id }
    end
  ...
  test "should update blogpost" do
    patch :update, id: @blogpost, blogpost: { comment_id: @blogpost.comment_id, content: @blogpost.content, user_id: @blogpost.user_id }
    assert_redirected_to blogpost_path(assigns(:blogpost))
  end
